...
## Application
 ...
 - The second half of the mentioned assignment was to develop a web application. The application was named ***MPG Prediction***. An instance is up & running at <https://subhagangopadhyay.shinyapps.io/Course9_Week4_SecondPart/>.
 ...
 - The application and the current presentation source codes can be found at <https://github.com/meet2subha/Course9>. The application comprises 3 files: *ui.R* (UI), *server.R* (backend) and *modelBuilding.R* (Random Forest predictor).
